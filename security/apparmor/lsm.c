...
/**
 * apparmor_lsm_set_self_policy - Stack a profile
 * @buf: buffer containing the user-provided name of the profile to stack
 * @size: size of @buf
 *
 * Returns: 0 on success, negative value on error
 */
static int apparmor_lsm_set_self_policy(u32 lsm_id, u32 op, void __user *buf,
...
/**
 * apparmor_lsm_set_system_policy - Load or replace a system policy
 ...
 * Returns: 0 on success, negative value on error
 */
static int apparmor_lsm_set_system_policy(u32 lsm_id, u32 op, void __user *buf,
				      size_t size, u32 flags)
{
...
static struct security_hook_list apparmor_hooks[] __ro_after_init = {
	...
	LSM_HOOK_INIT(lsm_set_self_policy, apparmor_lsm_set_self_policy),
	LSM_HOOK_INIT(lsm_set_system_policy, apparmor_lsm_set_system_policy),
#ifdef CONFIG_NETWORK_SECMARK

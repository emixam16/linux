 ...
 * Supported operations depend on the targeted LSM.
 *
 * Return: Returns 0 on success, error on failure.
 */
 ...
 * to update them even when the lsmfs is unavailable or restricted. Supported
 * operations depend on the targeted LSM.
 *
 * Return: Returns 0 on success, error on failure.
 */

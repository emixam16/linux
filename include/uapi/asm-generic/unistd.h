...
#define __NR_lsm_set_self_policy 468
__SYSCALL(__NR_lsm_set_self_policy, lsm_set_self_policy)
#define __NR_lsm_set_system_policy 469
__SYSCALL(__NR_lsm_set_system_policy, lsm_set_system_policy)
